...
namespace SAD_20
{
    class Lecture
    {
        ...
        public Lecture(Double duration, LectureType lectureType, int activityID, String email, String name, String description, Double price, String startDate, int capacity, String location, int seatsLeft)
        {
        ...
        public void create_lecture()
        {
            ...
            c.Parameters.AddWithValue("@lectureType", this.lectureType);
        ...
        {
            SqlCommand c = new SqlCommand();
            c.CommandText = "EXECUTE dbo.SP_Update_lecture @id, @duration, @Email, @name, @description, @price, @startDate, @capacity, @location, @seatsLeft";
