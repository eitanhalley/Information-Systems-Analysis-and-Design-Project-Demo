...
namespace SAD_20
{
    ...
    public class Workshop
    {
        ...
        public Workshop(int NumOfMeetings, string Repetivity, DateTime EndDate, int ActivityID, String Email, String name, String description, Double price, String startDate, int capacity, String location, int seatsLeft)
        {
